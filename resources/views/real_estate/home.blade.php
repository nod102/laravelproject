@extends('real_estate.master_temp')
    ...
    <div class="aa-slider-area"> 
      ...
      <div class="aa-top-slider">
        ...
        <div class="aa-top-slider-single">
          <img src="{{asset('real_estate/img/slider/3.jpg')}}" alt="img">
          <!-- Top slider content -->
        ...
        <!-- Top slider single slide -->
        <div class="aa-top-slider-single">
          <img src="{{asset('real_estate/img/slider/2.jpg')}}" alt="img">
          <!-- Top slider content -->
          <div class="aa-top-slider-content">
            <span class="aa-top-slider-catg">Duplex</span>
            <h2 class="aa-top-slider-title">1560 Square Feet</h2>
        ...
        <!-- Top slider single slide -->
        <div class="aa-top-slider-single">
          <img src="{{asset('real_estate/img/slider/1.jpg')}}" alt="img">
          <!-- Top slider content -->
          <div class="aa-top-slider-content">
            <span class="aa-top-slider-catg">Duplex</span>
            <h2 class="aa-top-slider-title">1560 Square Feet</h2>
        ...
        <!-- / Top slider single slide -->       
         <!-- Top slider single slide -->
        <div class="aa-top-slider-single">
          <img src="{{asset('real_estate/img/slider/5.jpg')}}" alt="img">
          <!-- Top slider content -->
          <div class="aa-top-slider-content">
            <span class="aa-top-slider-catg">Duplex</span>
            <h2 class="aa-top-slider-title">1560 Square Feet</h2>
        ...
        <!-- / Top slider single slide -->        
         <!-- Top slider single slide -->
        <div class="aa-top-slider-single">
          <img src="{{asset('real_estate/img/slider/4.jpg')}}" alt="img">
          <!-- Top slider content -->
          <div class="aa-top-slider-content">
            <span class="aa-top-slider-catg">Duplex</span>
            <h2 class="aa-top-slider-title">1560 Square Feet</h2>
        ...
        <!-- / Top slider single slide -->
         <!-- Top slider single slide -->
        <div class="aa-top-slider-single">
          <img src="{{asset('real_estate/img/slider/6.jpg')}}" alt="img">
          <!-- Top slider content -->
          <div class="aa-top-slider-content">
            <span class="aa-top-slider-catg">Duplex</span>
            <h2 class="aa-top-slider-title">1560 Square Feet</h2>
            ...
            <div class="row">
              <div class="col-md-5">
                <div class="aa-about-us-left">
                  <img src="{{asset('real_estate/img/about-us.png')}}" alt="image">
                </div>
              </div>
              <div class="col-md-7">
        ...
        <div class="aa-latest-properties-content">
          <div class="row">
            <div class="col-md-4">
              <article class="aa-properties-item">
                <a href="#" class="aa-properties-item-img">
                  <img src="{{asset('real_estate/img/item/1.jpg')}}" alt="img">
                </a>
            ...
            <div class="col-md-4">
              <article class="aa-properties-item">
                <a href="#" class="aa-properties-item-img">
                  <img src="{{asset('real_estate/img/item/2.jpg')}}" alt="img">
                </a>
            ...
            <div class="col-md-4">
              <article class="aa-properties-item">
                <a href="#" class="aa-properties-item-img">
                  <img src="{{asset('real_estate/img/item/3.jpg')}}" alt="img">
                </a>
            ...
            <div class="col-md-4">
              <article class="aa-properties-item">
                <a href="#" class="aa-properties-item-img">
                  <img src="{{asset('real_estate/img/item/4.jpg')}}" alt="img">
                </a>
                <div class="aa-tag for-sale">
                  For Sale
                </div>
            ...
            <div class="col-md-4">
              <article class="aa-properties-item">
                <a href="#" class="aa-properties-item-img">
                  <img src="{{asset('real_estate/img/item/5.jpg')}}" alt="img">
                </a>                
                <div class="aa-tag sold-out">
                  Sold Out
                </div>
            ...
            <div class="col-md-4">
              <article class="aa-properties-item">
                <a href="#" class="aa-properties-item-img">
                  <img src="{{asset('real_estate/img/item/6.jpg')}}" alt="img">
                </a>
                <div class="aa-tag for-rent">
                  For Rent
                </div>
            ...
            <div class="aa-agents-content">
              <ul class="aa-agents-slider">
                <li>
                  <div class="aa-single-agents">
                    <div class="aa-agents-img">
                      <img src="{{asset('real_estate/img/agents/agent-1.png')}}" alt="agent member image">
                    </div>
                ...
                <li>
                  <div class="aa-single-agents">
                    <div class="aa-agents-img">
                      <img src="{{asset('real_estate/img/agents/agent-5.png')}}" alt="agent member image">
                    </div>
                    <div class="aa-agetns-info">
                ...
                <li>
                  <div class="aa-single-agents">
                    <div class="aa-agents-img">
                      <img src="{{asset('real_estate/img/agents/agent-3.png')}}" alt="agent member image">
                    </div>
                    <div class="aa-agetns-info">
                ...
                <li>
                  <div class="aa-single-agents">
                    <div class="aa-agents-img">
                      <img src="{{asset('real_estate/img/agents/agent-4.png')}}" alt="agent member image">
                    </div>
                    <div class="aa-agetns-info">
                ...
                <li>
                  <div class="aa-testimonial-single">
                    <div class="aa-testimonial-img">
                      <img src="{{asset('real_estate/img/testimonial-1.png')}}" alt="testimonial img">
                    </div>
                 ...
                 <li>
                  <div class="aa-testimonial-single">
                    <div class="aa-testimonial-img">
                      <img src="{{asset('real_estate/img/testimonial-3.png')}}" alt="testimonial img">
                    </div>
                    <div class="aa-testimonial-info">
                      <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cupiditate consequuntur ducimus cumque iure modi nesciunt recusandae eligendi vitae voluptatibus, voluptatum tempore, ipsum nisi perspiciatis. Rerum nesciunt fuga ab natus, dolorem?</p>
                    </div>
                 ...
                 <li>
                  <div class="aa-testimonial-single">
                    <div class="aa-testimonial-img">
                      <img src="{{asset('real_estate/img/testimonial-2.png')}}" alt="testimonial img">
                    </div>
                    <div class="aa-testimonial-info">
                      <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cupiditate consequuntur ducimus cumque iure modi nesciunt recusandae eligendi vitae voluptatibus, voluptatum tempore, ipsum nisi perspiciatis. Rerum nesciunt fuga ab natus, dolorem?</p>
                    </div>
            ...
            <ul class="aa-client-brand-slider">
              <li>
                <div class="aa-client-single-brand">
                  <img src="{{asset('real_estate/img/client-brand-1.png')}}" alt="brand image">
                </div>
              </li>
              <li>
                <div class="aa-client-single-brand">
                  <img src="{{asset('real_estate/img/client-brand-2.png')}}" alt="brand image">
                </div>
              </li>
              <li>
                <div class="aa-client-single-brand">
                  <img src="{{asset('real_estate/img/client-brand-3.png')}}" alt="brand image">
                </div>
              </li>
              <li>
                <div class="aa-client-single-brand">
                  <img src="{{asset('real_estate/img/client-brand-5.png')}}" alt="brand image">
                </div>
              </li>
              <li>
                <div class="aa-client-single-brand">
                  <img src="{{asset('real_estate/img/client-brand-4.png')}}" alt="brand image">
                </div>
              </li>
               <li>
                <div class="aa-client-single-brand">
            ...
            <div class="aa-latest-blog-content">
              <div class="row">
                ...
                <div class="col-md-4">
                  <article class="aa-blog-single">
                    <figure class="aa-blog-img">
                      <a href="#"><img src="{{asset('real_estate/img/blog-img-1.jpg')}}" alt="img"></a>
                ...
                <div class="col-md-4">
                  <article class="aa-blog-single">
                    <figure class="aa-blog-img">
                      <a href="#"><img src="{{asset('real_estate/img/blog-img-2.jpg')}}" alt="img"></a>
                      <span class="aa-date-tag">15 April, 16</span>
                    </figure>
                    <div class="aa-blog-single-content">
                      <h3><a href="#">Lorem ipsum dolor sit amet, consectetur.</a></h3>
                ...
                <div class="col-md-4">
                  <article class="aa-blog-single">
                    <figure class="aa-blog-img">
                      <a href="#"><img src="{{asset('real_estate/img/blog-img-3.jpg')}}" alt="img"></a>
                      <span class="aa-date-tag">15 April, 16</span>
                    </figure>
                    <div class="aa-blog-single-content">
                      <h3><a href="#">Lorem ipsum dolor sit amet, consectetur.</a></h3>
